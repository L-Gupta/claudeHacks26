...
if (!globalThis.__helloNeighbourStore) {
  ...
  const seed = [
    ...
    // ── Sellery Hall ──
    {
      id: 'mock6', name: 'Priya', dorm: 'Sellery Hall', floor: 1, room: '103',
    ...
    {
      id: 'mock7', name: 'Ethan', dorm: 'Sellery Hall', floor: 1, room: '108',
    ...
    {
      id: 'mock8', name: 'Nina', dorm: 'Sellery Hall', floor: 1, room: '111',
